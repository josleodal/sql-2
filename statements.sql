...
UPDATE usuarios SET id_categoria = 1 WHERE id_usuario IN (1, 2, 3, 4);
UPDATE usuarios SET id_categoria = 2 WHERE id_usuario IN (4, 5, 6, 7);
UPDATE usuarios SET id_categoria = 3 WHERE id_usuario IN (8, 9, 10, 11);
UPDATE usuarios SET id_categoria = 4 WHERE id_usuario IN (12, 13, 14, 15);
UPDATE usuarios SET id_categoria = 5 WHERE id_usuario IN (16, 17, 18, 19,20);
